...
const identifikatory = nezaplaceneObjednavky.map((identifikator, hodnota) => {
	return nezaplaceneObjednavky[hodnota].id
})
const emaily = nezaplaceneObjednavky.map((email, hodnota) => {
	return nezaplaceneObjednavky[hodnota].uzivatel.email
})
