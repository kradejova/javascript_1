...
//ulozeni prvku do promenne pomoci querySelector(id prvku)
const seznamFilmu = document.querySelector("#seznam-filmu")

//zmena obsahu stranky pomoci metody map, ktera projde vsechny prvky pole filmy a zmeni jejich obsah na HTML obsahujici jednotlive polozky objektu
//metoda join na konci je potreba proto, ze jinak se na strance zobrazuje mezi elementy filmu carka, takto se carka nezobrazi
seznamFilmu.innerHTML = filmy.map((film) => {
